    ...
    <div class="grid grid-cols-1 md:grid-cols-8">
        <div class="hidden md:inline col-span-3 px-3 md:px-3 pt-6 pb-4 bg-cover"
            ...
            <img class="pb-3 max-w-[208px] mx-auto"
                src="<?= SERMA_BABY_GESTATIONAL_AGE_URL ?>/assets/img/ultrasound-gestational-age-bg.png">
        </div>
                ...
                <div class="grid grid-cols-5 mb-4">
                    <div class="col-span-3 flex items-center">
                        <img class="w-[20px] mr-2"
                            src="<?= SERMA_BABY_GESTATIONAL_AGE_URL ?>/assets/icons/ultrasound-gestational-age/embryo.svg">
...
<?= SERMA_BABY_GESTATIONAL_AGE_TEMPLATE::show_template('ultrasound-gestational-age/form/results') ?>