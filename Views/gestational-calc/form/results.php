<div ref="serma_gc_results" class="px-4 md:px-0">
    <div class="container border rounded-lg mt-6 border-[#ECAC4A]" v-if="show_result">
        ...
        <div class="grid grid-cols-1 pt-6 pl-4 pr-6 my-4">
            ...
            <div class="mt-6">
                <p class="text-center text-14px text-black">Fecha estimada de parto</p>
                <h3 class="text-16px text-black font-semibold text-center">{{ formatDate({d: results.date}) }}</h3>
            </div>
        </div>
